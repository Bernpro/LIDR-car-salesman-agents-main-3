...
class AdvancedCarSalesSystem:
    ...
    def __init__(self, groq_api_key: str, serpapi_api_key: str = None):
        ...
        self.carlos_llm = ChatGroq(
            temperature=0.8,  # Creative for sales conversations
            groq_api_key=groq_api_key,
            model_name="llama-3.3-70b-versatile",  # Modelo gratuito de Groq
            max_tokens=1000
        )
        
        self.maria_llm = ChatGroq(
            temperature=0.3,  # Factual for research
            groq_api_key=groq_api_key,
            model_name="llama-3.1-8b-instant",  # Modelo gratuito de Groq, rápido
            max_tokens=800
        )
        
        self.manager_llm = ChatGroq(
...
def get_advanced_multi_agent_system(groq_api_key: str, serpapi_api_key: str = None) -> AdvancedCarSalesSystem:
    """Factory function to create the advanced multi-agent system (Groq backend)"""
    return AdvancedCarSalesSystem(groq_api_key, serpapi_api_key)